...
import {StateFullOffers} from '../view/event-edit';


interface EventAddTemplateProps {
	state: Point,
...
const getEventAddTemplate = ({state, eventTypes, destinationsNames, destination}: EventAddTemplateProps, offers: StateFullOffers[]) =>
	`<form class="event event--edit" action="#" method="post">
                    <header class="event__header">
                      ...
                      <div class="event__field-group  event__field-group--destination">
                        ...
                        <input class="event__input  event__input--destination" id="event-destination-1" type="text" name="event-destination" value="${state.destination}" list="destination-list-1">
                      ...
                      <div class="event__field-group  event__field-group--time">
                        ...
                        <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${state.dateFrom.format('YY/MM/DD hh:mm')}">
                        &mdash;
                        <label class="visually-hidden" for="event-end-time-1">To</label>
                        <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${state.dateTo.format('YY/MM/DD hh:mm')}">
                      </div>
